...
ALARM_PATH := vendor/harmony/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/harmony/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/harmony/prebuilt/common/media/audio/ringtones
